                    ...
                    <div class="grid gap-4">
                        <div class="flex gap-7">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-900 text-center dark:text-white text-3xl leading-none font-bold">9</p>
                            </div>
                        </div>
                        <div>
                        </div>
                    ...
                    <div class="grid gap-4">
                        <div class="flex gap-7">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-900 text-center dark:text-white text-3xl leading-none font-bold">7</p>
                            </div>
                        </div>
                        <div>
                        </div>
                    ...
                    <div class="grid gap-4">
                        <div class="flex gap-7">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-900 text-center dark:text-white text-3xl leading-none font-bold">4</p>
                            </div>
                        </div>
                        <div>
                        </div>
                ...
                <div class="flex justify-between mb-5">
                    <div class="grid gap-4 grid-cols-2">
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">3</p>
                        </div>
                        <div>
