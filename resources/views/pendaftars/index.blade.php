<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="w-full px-10 min-h-screen py-10">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Daftar Pendaftar {{ $pendaftars->first()->sakramenEvent->nama_event}}</h2>
                    ...
                    <tbody>
                        @foreach ($pendaftars as $pendaftar)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('pendaftars.show', $pendaftar->id) }}" class="text-blue-600 dark:text-blue-500 hover:underline">Lihat Detail</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
